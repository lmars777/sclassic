...
SKYPE.inclient.Trackable = (function () { 
  ...
  /* Channels */
  trackableAffiliate = function (a_referrer, a_url, a_param) {
        
    var affiliate_arr = { "200504paffiliate": "211" },
        segment       = { cookie: "", cookie_time: 90 };
    
    if (affiliate_arr[readCookie("linkedcampaign")] !== undefined)  {
      segment.cookie = affiliate_arr[readCookie("linkedcampaign")];
      
      /* Traffic Broker segmentation */
      if (segment.cookie === "211" && 
         (a_param.indexOf("sid=1010") !== -1)) {
        segment.cookie = "228";
      }
      
      /* 296 segmentation */
      if (segment.cookie === "211" && 
         (a_param.indexOf("sid=2943525") !== -1)) {
        segment.cookie = "296";
      }
    }
  ...
  trackablePaid = function (a_referrer, a_url, a_param) {
    ...
    paids   = [
      ...
      // GAWS
      { name: "209", regex: /paids\|/, stop: true }
  ...
  getAllSegmentMethods = function () { 
    return [trackableNatural, trackablePaid, trackableTagger, 
            trackableCustom, trackableTransparent, trackableAffiliate];
  };
...
SKYPE.flash._player = function(url) {
	...
	var writeIPhone = function(divId, url, width, height) {
		if (_getById(divId)) {
			_getById(divId).innerHTML = '<embed src="'+url+'" target="myself" width="'+width+'" height="'+height+'" controller="false" autoplay="false" scale="1" cache="true" type="video/quicktime" pluginspage="https://web.archive.org/web/20110702115809/http://www.apple.com/quicktime/download/"/>';
		}
	};
...
SKYPE.flash.VideoPlayer         = SKYPE.flash._player("https://web.archive.org/web/20110702115809/http://download.skype.com/share/videos/player.swf");
SKYPE.flash.BusinessVideoPlayer = SKYPE.flash._player("https://web.archive.org/web/20110702115809/http://download.skype.com/share/videos/business/player.swf");

if (SKYPE.settings.waMode == "staging") {
    SKYPE.flash.VideoPlayer         = SKYPE.flash._player("https://web.archive.org/web/20110702115809/http://staging.skype.com/temp/videoplayer/player.swf");
    SKYPE.flash.BusinessVideoPlayer = SKYPE.flash._player("https://web.archive.org/web/20110702115809/http://staging.skype.com/temp/videoplayer/player-biz.swf");
}

}
/*
     FILE ARCHIVED ON 11:58:09 Jul 02, 2011 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 6.03
  LoadShardBlock: 180.492 (6)
  PetaboxLoader3.datanode: 177.821 (7)
  load_resource: 186.658
  PetaboxLoader3.resolve: 138.283
*/