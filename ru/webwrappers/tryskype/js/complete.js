...
SKYPE.inclient.Trackable.segment();/*global YAHOO, SKYPE, swfobject, container, makeContainerDiv, document, console, pageTracker, aCustomInclient*/
...
SKYPE.flash._player = function(url) {
	...
	var writeIPhone = function(divId, url, width, height) {
		if (_getById(divId)) {
			_getById(divId).innerHTML = '<embed src="'+url+'" target="myself" width="'+width+'" height="'+height+'" controller="false" autoplay="false" scale="1" cache="true" type="video/quicktime" pluginspage="https://web.archive.org/web/20110104183332/http://www.apple.com/quicktime/download/"/>';
		}
	};
...
SKYPE.flash.VideoPlayer         = SKYPE.flash._player("https://web.archive.org/web/20110104183332/http://download.skype.com/share/videos/player.swf");
SKYPE.flash.BusinessVideoPlayer = SKYPE.flash._player("https://web.archive.org/web/20110104183332/http://download.skype.com/share/videos/business/player.swf");

if (SKYPE.settings.waMode == "staging") {
    SKYPE.flash.VideoPlayer         = SKYPE.flash._player("https://web.archive.org/web/20110104183332/http://staging.skype.com/temp/videoplayer/player.swf");
    SKYPE.flash.BusinessVideoPlayer = SKYPE.flash._player("https://web.archive.org/web/20110104183332/http://staging.skype.com/temp/videoplayer/player-biz.swf");
}

}
/*
     FILE ARCHIVED ON 18:33:32 Jan 04, 2011 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.015
  cdx.remote: 6.506
  LoadShardBlock: 259.05 (6)
  PetaboxLoader3.datanode: 135.792 (8)
  PetaboxLoader3.resolve: 532.099 (3)
  load_resource: 419.506 (2)
*/